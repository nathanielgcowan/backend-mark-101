...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { genre: @band.genre, name: @band.name, rating: @band.rating } }, as: :json
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { genre: @band.genre, name: @band.name, rating: @band.rating } }, as: :json
    assert_response 200
  end
